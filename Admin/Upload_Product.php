                    ...
                    <div class="card card-table-one">
                        <div class="table-responsive">
                            <form action="" method="POST" enctype="multipart/form-data" class="form1">
                                ...
                                <label for="">Des</label>
                                <br>
                                <textarea name="des" id="" cols="95" rows="3" class="input"></textarea>
                                <br>
                                <label for="">Price</label>
                                <br>
                                <input type="text" name="price" class="input" style="width: 100%">
                                <br>
                                <label for="">Amount</label>
                                <br>
                                <input type="text" name="amount" class="input" style="width: 100%">
                                <br>
                                <label for="">Category_ID</label>
                                <br>
                                <input type="text" name="" class="input1" style="width: 100%">
                                <br>
                                ...
                                <br>
                                <br>
                                <button type="submit" name="sub" style="border-color: #5b47fb; width:15%; height:10%; background:#5b47fb;border-radius:10px">ADD</button>
